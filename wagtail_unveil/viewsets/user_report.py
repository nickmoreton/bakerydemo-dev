...
from ..helpers.user import get_user_urls
...
class UnveilUserReportIndexView(IndexView):
    ...
    def get_queryset(self):
        ...
        user_urls = get_user_urls(output, base_url, max_instances, user)
...
class UnveilUserReportViewSet(ViewSet):
    ...
    def index_view_class(self):
        return UnveilUserReportIndexView
