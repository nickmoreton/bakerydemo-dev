...
urlpatterns = [
    path('collection/', collection_api_viewset.as_json_view, name='unveil_collection_api'),
    path('document/', document_api_viewset.as_json_view, name='unveil_document_api'),
    path('form/', form_api_viewset.as_json_view, name='unveil_form_api'),
    path('generic/', generic_api_viewset.as_json_view, name='unveil_generic_api'),
    path('image/', image_api_viewset.as_json_view, name='unveil_image_api'),
    path('locale/', locale_api_viewset.as_json_view, name='unveil_locale_api'),
    path('page/', page_api_viewset.as_json_view, name='unveil_page_api'),
    path('redirect/', redirect_api_viewset.as_json_view, name='unveil_redirect_api'),
    path('search-promotion/', search_promotion_api_viewset.as_json_view, name='unveil_search_promotion_api'),
    path('settings/', settings_api_viewset.as_json_view, name='unveil_settings_api'),
    path('site/', site_api_viewset.as_json_view, name='unveil_site_api'),
    path('snippet/', snippet_api_viewset.as_json_view, name='unveil_snippet_api'),
    path('user/', user_api_viewset.as_json_view, name='unveil_user_api'),
    path('admin/', admin_api_viewset.as_json_view, name='unveil_admin_api'),
    path('workflow/', workflow_api_viewset.as_json_view, name='unveil_workflow_api'),
    path('workflow-task/', workflow_task_api_viewset.as_json_view, name='unveil_workflow_task_api'),
]
